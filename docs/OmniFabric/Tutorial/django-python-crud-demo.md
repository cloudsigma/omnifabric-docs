...
def add_book(request):
    books = models.Book.objects.create(title="Journey Under the Midnight Sun",price=39.50,publish="Nanhai Publishing Company",pub_date="2010-10-10")
...
+------+-----------+-------+--------------------+------------+
|    1 | Journey Under the Midnight Sun     | 39.50 | Nanhai Publishing Company         | 2010-10-10 |
+------+-----------+-------+--------------------+------------+
...
| id   | title     | price | publish            | pub_date   |
+------+-----------+-------+--------------------+------------+
|    1 | Journey Under the Midnight Sun     | 50.00 | Nanhai Publishing Company         | 2010-10-10 |
+------+-----------+-------+--------------------+------------+
1 row in set (0.00 sec)
```
