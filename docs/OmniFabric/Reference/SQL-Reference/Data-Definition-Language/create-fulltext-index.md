...
(1, 'Hello, world!', 'Hello World', '{"name": "Alice", "age": 30}'),
(2, 'This is a test.', 'This is a test', '{"name": "Bob", "age": 25}'),
(3, 'Full-text search is powerful.', 'Full-text search is powerful', '{"name": "Charlie", "age": 35}');
...
+------+---------------+--------------+------------------------------+
|    1 | Hello, world! | Hello World     | {"age": 30, "name": "Alice"} |
+------+---------------+--------------+------------------------------+
1 row in set (0.02 sec)

-- Search for text containing "Hello"
mysql> SELECT * FROM example_table WHERE MATCH(chinese_text) AGAINST('Hello');
+------+---------------+--------------+------------------------------+
| id   | english_text  | chinese_text | json_data                    |
+------+---------------+--------------+------------------------------+
|    1 | Hello, world! | Hello World     | {"age": 30, "name": "Alice"} |
...
| id   | english_text    | chinese_text       | json_data                  |
+------+-----------------+--------------------+----------------------------+
|    2 | This is a test. | This is a test       | {"age": 25, "name": "Bob"} |
+------+-----------------+--------------------+----------------------------+
1 row in set (0.01 sec)
...
| id   | english_text                  | chinese_text          | json_data                      |
+------+-------------------------------+-----------------------+--------------------------------+
|    3 | Full-text search is powerful. | Full-text search is powerful        | {"age": 35, "name": "Charlie"} |
+------+-------------------------------+-----------------------+--------------------------------+
1 row in set (0.01 sec)
