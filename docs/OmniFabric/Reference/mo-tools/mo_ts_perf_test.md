...
Press Y or Enter to start inserting data, press N to exit, starting test 1, txc=0
...
Press Y or Enter to start inserting data, press N to exit, starting test 1, txc=10

start test 1 …….
Start transaction commit write, records per transaction commit: 10
spend time:9.482012 s
1 test: 4000000/9.482012 = 421851.388088 records/second
Press Y or Enter to start inserting data, press N to exit, starting test 2, txc=10
...
Press Y or Enter to start inserting data, press N to exit, starting test 3, txc=10
