...
1. Follow the steps in the [Quick Start](../../Get-Started/basic-sql.md) chapter to complete the deployment of OmniFabric using mo\_ctl. When the deployment is complete, execute the following command to modify the configuration of mo\_ctl:
