...
- Completed [Installation and startup of OmniFabric](../../Get-Started/basic-sql.md).
...
For an example of using C# to build a simple CRUD with OmniFabric, see the C# Basic Examples tutorial.
