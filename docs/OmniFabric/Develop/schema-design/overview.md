...
OmniFabric supports both user-based and role-based access control. To allow users to view, modify, or delete data, you can grant appropriate privileges to users and roles.
