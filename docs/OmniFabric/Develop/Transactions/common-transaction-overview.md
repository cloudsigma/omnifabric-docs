...
For more information on optimistic transactions in OmniFabric, see [Optimistic Transaction](omnifabric-transaction-overview/optimistic-transaction.md).

For more information on optimistic transactions in OmniFabric, see [Pessimistic Transaction](omnifabric-transaction-overview/pessimistic-transaction.md).
...
!!! note
    OmniFabric's transaction isolation is slightly different from the general isolation definition and isolation level division; see [Isolation level in OmniFabric](omnifabric-transaction-overview/isolation-level.md).
