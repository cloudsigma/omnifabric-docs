...
- **Building a map (text) search application**: For more information, check out the Example of a basic map search application Foundation example in the app development example.
